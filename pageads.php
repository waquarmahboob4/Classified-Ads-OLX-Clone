...
<section class="ads">
        ...
        $rowreport=mysqli_fetch_assoc($resultreport) ?? array("UserID"=>"null");
                    ...
                    <div class="row">
                        <aside class="col-sm-5 border-right">
                            ...
                            <div class=" pl-5">
                                <dl class="param param-feature">
                                    <dt>user name</dt>
                                    <dd><a href="#"><span class="glyphicon glyphicon-user"></span><?php echo " ".$rowuser['UserName'];?></a></dd>
                                </dl>  <!-- item-property-hor .// -->
                                <dl class="param param-feature">
                                    <dt><i class="fa-regular fa-envelope"></i>Email </dt>
                                    <dd><a href="mailto:<?php echo $rowuser['Email'];?>"><span class="glyphicon glyphicon-envelope"></span><?php echo " ".$rowuser['Email'];?></a></dd>
                                </dl>  <!-- item-property-hor .// -->
                                <dl class="param param-feature">
                                    <dt>phone</dt>
                                    <dd><a href="tel:<?php echo $rowuser['Phone'];?>"><span class="glyphicon glyphicon-earphone"></span><?php echo " ".$rowuser['Phone'];?></a></dd>
                            </dl>  <!-- item-property-hor .// -->
                            </dl>  <!-- item-property-hor .// -->
                            <dl class="param param-feature">
                                <dt>Address</dt>
                                <dd><a href="#"><span class="glyphicon glyphicon-map-marker"></span><?php echo " ".$rowcity['cityName'] ." , ".$rowareas['areaName'];?></a></dd>
                            </dl>  <!-- item-property-hor .// -->
                            </div> <!-- card-body.// -->
                        </aside>
                        <aside class="col-sm-7">
                            ...
                            <dl class="item-property">
                                <dt>Description</dt>
                                    <dd><a href="#"><p><?php echo $rowADS['Details'];?></p></a></dd>
                            </dl>
                            <dl class="param param-feature">
                                <dt><span class="glyphicon glyphicon-tag"></span> price</dt>
                                <dd><a href="#"><b class="font-weight-bolder">₹<b><?php echo " ".$rowADS['Price'];?></a></dd>
                            <dl class="param param-feature">
                                <dt>date</dt>
                                <dd><a href=""><span class="glyphicon glyphicon-calendar"></span><?php echo " ".$rowADS['Date'];?></a></dd>
                            </dl>  <!-- item-property-hor .// -->
                            <dl class="param param-feature">
                                <dt><span class="glyphicon glyphicon-menu-hamburger"></span> category</dt>
                                <dd><a href="#"><?php echo $rowCategory['CategoryName'];?></a></dd>
                            </dl>  <!-- item-property-hor .// -->
                            <hr>
